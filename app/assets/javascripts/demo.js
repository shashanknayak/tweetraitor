$(document).ready(function() {
	...
	function start(){
	  ...
	  $('#read').fadeIn(200).html("READ");
	  $('#read').fadeIn(200).append(" the tweet.");
	...
	function spam(){		
	  ...
	  $('#read').html("If it is not useful.<br >Then TYPE the red word.").fadeIn(200);
	  $('#read').css('z-index',2).delay(1000);
	...
	function notspam(){		
	  ...
	  $('#read').html("Otherwise.<br >TYPE the green word before the meteor hits the ship.").fadeIn(200).delay(1000);
	  $('#read').css('z-index',2).delay(1000);
